...
- Default copyright should be "© 2025. Made with ❤️ by 0xdevrel. All rights reserved." unless user specifies otherwise
...
✓ Footer with "© 2025. Made with ❤️ by 0xdevrel. All rights reserved." copyright
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { prompt, previousContext, stream = false } = body as GenerateCodeRequest & { stream?: boolean };
